...
--
-- Table structure for table `MyAnimeListAnimes`
--

DROP TABLE IF EXISTS `MyAnimeListAnimes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `MyAnimeListAnimes` (
  `anime_name` text,
  `anime_url` text,
  `anime_img` text,
  `Synonyms` text,
...
-- Dump completed on 2022-02-22 17:36:32
