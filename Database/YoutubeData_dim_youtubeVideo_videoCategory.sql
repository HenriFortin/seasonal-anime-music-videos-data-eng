...
--
-- Table structure for table `dim_youtubeVideo_videoCategory`
--

DROP TABLE IF EXISTS `dim_youtubeVideo_videoCategory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dim_youtubeVideo_videoCategory` (
...
-- Dump completed on 2022-02-22 17:36:33
