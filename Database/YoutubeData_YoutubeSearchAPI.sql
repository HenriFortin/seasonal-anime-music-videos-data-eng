...
--
-- Table structure for table `YoutubeSearchAPI`
--

DROP TABLE IF EXISTS `YoutubeSearchAPI`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `YoutubeSearchAPI` (
  `animeId` bigint DEFAULT NULL,
  `etag` text,
  `id` text,
  `processedAt` text,
  `publishedAt` text,
...
-- Dump completed on 2022-02-22 17:36:36
